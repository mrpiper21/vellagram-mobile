...
const CustomPasscodeBottomSheet: React.FC<CustomPasscodeBottomSheetProps> = ({
	...
	return (
		...
		>
			<KeyboardAvoidingView
				style={[styles.backdrop, { backgroundColor: theme.background + "CC" }]}
			...
			>
				...
				>
					...
					<Text style={[styles.subtitle, { color: theme.textSecondary }]}>
						Enter your 4-digit PIN or use biometrics to decypher this message.
					</Text>
					<Animated.View
						style={[
					...
					{error ? (
						<Text style={[styles.error, { color: theme.accent || "#e74c3c" }]}>
							{error}
						</Text>
					) : null}
